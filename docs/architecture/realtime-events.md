# Realtime and Event Contract

> Governing asynchronous event, browser realtime, and Partner webhook behavior for the TktSync MVP.
...
6. [Security and Authentication](security.md)
