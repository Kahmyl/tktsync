...
> Governing architecture, transactional consistency model, concurrency strategy, failure behavior, deployment topology, and command design for the TktSync MVP.
...
1. [**Platform Policy**](platform-policy.md)
2. [**Logical Domain Model**](domain-model.md)
3. **This System Architecture and Transactional Design document**
4. [Relational Data Model](data-model.md)
5. [API and Partner Integration Contract](../api-contract.md)
6. [Realtime and Event Contract](realtime-events.md)
7. [Security and Authentication](security.md)
