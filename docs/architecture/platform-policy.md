...
> Governing operating processes, policy rules, state semantics, responsibility boundaries, and platform invariants for the TktSync MVP and compatible Partner integrations.
