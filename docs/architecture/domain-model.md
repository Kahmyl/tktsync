...
> Governing domain concepts, state machines, ownership relationships, authorization boundaries, and business invariants for the TktSync MVP.

Normative parent: [Platform Policy](platform-policy.md). Product basis: TktSync Technical Brief (2026).
...
1. [**Platform Policy**](platform-policy.md) — authoritative platform policy.
2. **This Logical Domain Model** — authoritative translation of that policy into domain semantics.
