...
func TestM5ReservationLifecycleAndSourceRestoration(
	t *testing.T,
) {
	f := newFixture(t)
...
func TestM5MixedAtomicityAndReservedConcurrency(
	t *testing.T,
) {
	f := newFixture(t)
...
func TestM5CheckoutRetryReconciliationAndTokenRecovery(
	t *testing.T,
) {
	f := newFixture(t)
...
func TestM5DefinitiveFailureDuringReconciliation(
	t *testing.T,
) {
	f := newFixture(t)
...
func TestM5ModificationAndWorkerExpiry(
	t *testing.T,
) {
	f := newFixture(t)
