    ...
    actions: [
      ...
      },
      {
        ...
        instructions: [
          ...
          'Set Sales open to at least 10 minutes before the current time. This places the review inside the sales window, so Admin can open sales immediately and the Partner storefront can sell a ticket now. A future Sales open time schedules sales for later and blocks the purchase journey until then.',
          'Set Sales close after the review so the purchase window remains active while you complete checkout.',
          'Set Admission open to at least 10 minutes before the current time. This places the review inside the admission window, so Scanner can admit the issued ticket now. A future Admission open time correctly returns Entry is not open until that time arrives.',
          'Set Admission close after the review—preferably after the Event ends—so the gate remains open while you complete the Scanner proof.',
        ...
        note: 'These are separate safeguards, not workarounds: the sales window controls when tickets may be bought, and the admission window controls when active tickets may enter. Creating the draft still does not put tickets on sale until you deliberately choose Open sales.',
      },
      {
