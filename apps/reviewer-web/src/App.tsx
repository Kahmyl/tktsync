    ...
    actions: [
      ...
      },
      {
        ...
        instructions: [
          ...
          'Review timing: set both Sales open and Admission open to at least 10 minutes before the current time. Set Sales close and Admission close after the review; Admission close should preferably be after the Event ends.',
          'Why: these times let you buy a ticket and test Scanner during this review. If you set Admission open to a future date—for example, 26 October—Scanner will show Entry is not open until 26 October arrives. A future Sales open time similarly means you must wait until that time before the Partner storefront can sell the ticket.',
        ...
        note: 'Use the review timing above so you can complete the purchase and Scanner proof now rather than waiting for a future sales or admission date. Creating the draft still does not put tickets on sale until you deliberately choose Open sales.',
      },
      {
